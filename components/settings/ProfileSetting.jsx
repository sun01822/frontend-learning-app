        ...
        <div className="bg-white border-b py-6 px-5 rounded-lg mt-2">
            <div className="flex flex-col md:flex-row justify-between mt-4">
                <div className="account ">
                    ...
                    <input type="text" Value="Md. Rakibuzzaman" className="input input-bordered w-full max-w-xs" />
                ...
                <div className="study">
                    ...
                    <input type="text" Value="Varendra University" className="input input-bordered w-full max-w-xs" />

                    <label className="label">
                        <span className="label-text">I study in </span>
                    </label>
                    <input type="text" Value="CSE" className="input input-bordered w-full max-w-xs" />
